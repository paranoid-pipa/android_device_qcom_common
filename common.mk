...
ifneq ($(filter $(4_9_FAMILY) $(4_14_FAMILY) $(4_19_FAMILY) $(5_4_FAMILY) $(5_10_FAMILY) $(5_15_FAMILY) $(6_1_FAMILY) $(6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
    SOONG_CONFIG_qtidisplay_drmpp := true
endif

# Enable Gralloc4 on UM platforms that support it
ifneq ($(filter $(4_14_FAMILY) $(4_19_FAMILY) $(UM_4_19_LEGACY_FAMILY) $(5_4_FAMILY) $(5_10_FAMILY) $(5_15_FAMILY) $(6_1_FAMILY) $(6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
    SOONG_CONFIG_qtidisplay_gralloc4 := true
endif

# Select AR variant of A-HAL dependencies
ifneq ($(filter $(5_10_FAMILY) $(5_15_FAMILY) $(6_1_FAMILY) $(6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter $(6_1_FAMILY) $(6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
MASTER_SIDE_CP_TARGET_LIST := msm8996 $(4_4_FAMILY) $(4_9_FAMILY) $(4_14_FAMILY) $(4_19_FAMILY)
...
ifeq ($(filter $(5_15_FAMILY) $(6_1_FAMILY) $(6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter $(QSSI_SUPPORTED_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
    ...
    ifeq ($(filter $(5_10_FAMILY) $(5_15_FAMILY) $(6_1_FAMILY) $(6_6_FAMILY),$(TARGET_BOARD_PLATFORM)),)
        PRODUCT_SOONG_NAMESPACES += \
...
ifeq ($(BOARD_SUPPORTS_OPENSOURCE_STHAL),true)
    ifneq ($(filter $(LEGACY_UM_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
        ...
        ifneq ($(filter $(5_10_FAMILY) $(5_15_FAMILY) $(6_1_FAMILY),$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter $(LEGACY_UM_PLATFORMS),$(TARGET_BOARD_PLATFORM)),)
    PRODUCT_SOONG_NAMESPACES += hardware/qcom-caf/thermal-legacy
else
